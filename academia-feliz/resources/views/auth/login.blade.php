                    ...
                    <div class="row g-0">
                        ...
                        <div class="card-body p-md-5 mx-md-4">
                            ...
                            <div data-mdb-input-init class="form-outline mb-4">
                                ...
                                <input type="password" id="form2Example22" class="form-control" placeholder="Contraseña" name="contrasena">
                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-center pb-4">
                                ...
                                <a  href="{{route("register")}}" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger">Crear una nueva</a>
                            </div>
